...
export const Header = () => {
 return(
    <div className='sticky top-0 z-30 w-full md:relative backdrop-blur-sm bg-white/30 border-b border-slate-200 py-3 mb-4 px-10 mx-auto font-body'>
        ...
        <Link href="#" className="hover:underline"><h1 className='text-2xl md:text-4xl font-bold text-slate-900'>OHIS</h1></Link>
        <div className='text-sm lg:text-lg text-slate-700 flex gap-10'>
        <Link href="#" className='hidden md:block hover:underline '><svg className='w-6 inline'fill="none" viewBox="0 0 24 24" astro-icon="notebook"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.25 18.25h-8.5a2 2 0 0 1-2-2v-9.5a2 2 0 0 1 2-2h8.5a2 2 0 0 1 2 2v9.5a2 2 0 0 1-2 2ZM14.25 8.75h-.5M14.25 11.75h-.5M9.75 4.75v14.5"></path></svg>Blog</Link>
