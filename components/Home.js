...
export const Home = () => {
 return(
 <>
  <main className="pt-4 font-body flex flex-col mx-16 justify-center min-h-screen-[100vh]">
    <Header/>
  <h1 className="text-3xl font-lighter leading-1 w-1/2 mb-4">Connoisseur of everything with an interface.</h1>
